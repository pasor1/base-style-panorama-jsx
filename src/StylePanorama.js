  ...
  return (
    <div>
      ...
      <main role="main" style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-evenly' }}>
        ...
        <div style={{ width: '46%', margin: '10px' }}>
          <p style={{ margin: '10px 10px 0', color: '#555' }} id="text">Audio</p>
          <div style={{ border: '1px solid #bbb', padding: '10px', borderRadius: '10px' }}>
            <audio controls>audio</audio>
          </div>
        </div>
        <div style={{ width: '46%', margin: '10px' }}>
          <p style={{ margin: '10px 10px 0', color: '#555' }} id="text">Video</p>
          <div style={{ border: '1px solid #bbb', padding: '10px', borderRadius: '10px' }}>
            <video controls>video</video>
          </div>
        </div>
        <div style={{ width: '46%', margin: '10px' }}>
          <p style={{ margin: '10px 10px 0', color: '#555' }} id="text">Various elemets</p>
          <div style={{ border: '1px solid #bbb', padding: '10px', borderRadius: '10px' }}>
            <p>Horizontal rules</p>
            <hr />
            <p>
              Meter indicators:
              <meter defaultValue="2" min="0" max="10">2 out of 10</meter>
            </p>
            <p>
              Progress bars:
        ...
        <div style={{ width: '46%', margin: '10px' }}>
          <p style={{ margin: '10px 10px 0', color: '#555' }} id="text">Text</p>
          <div style={{ border: '1px solid #bbb', padding: '10px', borderRadius: '10px' }}>
          ...
          <form>
            ...
            <fieldset id="forms__checkbox">
              ...
              <ul className="list list--bare">
                <li><label htmlFor="checkbox1"><input id="checkbox1" name="checkbox" type="checkbox" defaultChecked="checked" /> Choice
                  A</label></li>
            ...
            <fieldset id="forms__radio">
              ...
              <ul className="list list--bare">
                <li><label htmlFor="radio1"><input id="radio1" name="radio" type="radio" className="radio" defaultChecked="checked" />
                  Option 1</label></li>
